...
[source,bash]
----
    ./create-unified-template.sh > ../openshift/launchpad-template.yaml
----

For this script to work it's required to have the other launchpad projects (launchpad-missioncontrol, launchpad-backend and launchjpad-frontend) cloned in the same folder as this project.
